...
**Metadata** is per-year: `alias` = `COL{yy}`, `title` = "Catalogue of Life Checklist", `version` = "Annual Checklist {year}", `url` = `https://www.catalogueoflife.org/annual-checklist/{year}/`, creator organisation *Species 2000 & ITIS Catalogue of Life* (Reading, GB through 2013; Leiden, NL from 2014) plus the published editor list for 2011–2019, and an `issn` for 2016–2019.
